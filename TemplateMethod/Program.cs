...
namespace TemplateMethod
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine(algorithm.GenerateScore(8,new TimeSpan(0,2,14)));
            algorithm = new WomenScoringAlgorithm();
            Console.WriteLine(algorithm.GenerateScore(9,new TimeSpan(0,2,24)));
            algorithm=new ChildrensScoringAlgorithm();
            Console.WriteLine(algorithm.GenerateScore(7,new TimeSpan(0,1,54)));
